...
const Footer2 = () => {
  return (
    <div className="maxW-full my-44">
      <div
        className="w-[100%] sm:w-[95%] md:w-[75%] bg-green-50 sm:rounded-3xl flex flex-col md:flex-row flex-start  md:justify-between items-center mx-auto py-2
          "
      >
        <div className="basis-[70%] text-start my-16 ml-16">
          <div className="flex gap-3 mx-auto">
            <h1 className="text-xl sm:text-3xl font-semibold ">
              UI Templates are ontheir way{" "}
            </h1>
            <img src="/assets/rocket.svg" alt="Rocket" className="w-8 h-8" />
          </div>
          <p className="text-gray-600 mt-4">
            Offical UI templates build on Atomixe React will be released very
            soon.
          </p>
        </div>
