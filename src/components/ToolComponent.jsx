      ...
      <div className=" w-[100%] sm:[85%] flex flex-col  sm:shadow-md ">
        ...
        <div className="w-[95%] sm:w-[75%] flex flex-col sm:flex-row gap-2 justify-between items-center mx-auto my-28  ">
          <div className=" h-[330px] flex flex-col items-start gap-8 shadow-lg rounded-lg p-4">
            ...
            >
              <g fill="none">
                <polygon
                  fill="#FDB300"
                  points="17.655 0 7.704 1.052 0 11.394 17.655 31.953 35.31 11.394 27.606 1.052"
                />
                <path
                  fill="#EB6C00"
                  d="M0,11.3942069 L17.6551724,31.9533793 L7.15117241,11.3942069 L0,11.3942069 Z M28.1590345,11.3942069 L17.6551724,31.9533793 L35.3103448,11.3942069 L28.1590345,11.3942069 Z"
                />
                <polygon
                  fill="#FDAD00"
                  points="7.151 11.394 17.655 31.953 28.159 11.394"
                />
                <path
                  fill="#FDD231"
                  d="M7.70413793,1.05213793 L7.15103448,11.3942069 L17.6551724,0 L7.70413793,1.05213793 Z M28.1590345,11.3942069 L27.6062069,1.05213793 L17.6551724,0 L28.1590345,11.3942069 Z"
                />
                <path
                  fill="#FDAD00"
                  d="M28.1591724,11.3942069 L35.3103448,11.3942069 L27.6063448,1.05213793 L28.1591724,11.3942069 Z M0,11.3942069 L7.15117241,11.3942069 L7.70413793,1.05213793 L0,11.3942069 Z"
                />
                <polygon
                  fill="#FEEEB7"
                  points="17.655 0 7.151 11.394 28.159 11.394"
                />
              </g>
            </svg>

            <div className="flex flex-col items-start">
              <h2 className="text-2xl font-semibold my-4">Design</h2>
              <p className="w-[75%] text-gray-500 text-start  ">
          ...
          <div className="h-[330px] flex flex-col items-start gap-8 shadow-lg rounded-lg p-4">
            ...
            <div className="flex flex-col items-start">
              <h2 className="text-2xl font-semibold my-4">Development</h2>
