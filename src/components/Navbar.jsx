...
const Navbar = () => {
    ...
    return (
        <div className="h-screen">
                ...
                <nav className="flex justify-between items-center w-[100%] mx-auto p-3 bg-[#F6F6F6] shadow-lg ">
                    <div>
                        <img
                    ...
                    <div
                        className={`duration-500 md:static absolute bg-[#F6F6F6] md:min-h-fit min-h-[60vh] left-0 ${
                            menuOpen ? 'top-[7%] text-start' : 'top-[-100%]'
                        } md:w-auto w-full flex items-center  px-5`}
                    >
                        <ul className="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-8 text-lg text-gray-700 ">
                            <li>
